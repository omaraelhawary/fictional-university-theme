...
class myNotes {
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".update-note").on("click", this.saveNote.bind(this));
  ...
  submitNote(e) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      success: response => {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("").prependTo("#my-notes").hide().slideDown();
        console.log("added");
        console.log(response);
      },
      error: response => {
...
class Search {
  ...
  async getResults() {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(`${uniData.root_url}/wp-json/university/v1/search?keyword=${this.searchField.value}`);
